...
function crispprop_gallery_metabox($post_type) {
  $types = array('property');

  if (in_array($post_type, $types)) {
    add_meta_box(
      'gallery-metabox',
      __( "Property Images", 'crispprop' ),
      'crispprop_gallery_images',
      $post_type,
      'normal',
      'default'
    );
...
add_action('add_meta_boxes', 'crispprop_gallery_metabox');

function crispprop_gallery_images($post) {
...
function crispprop_gallery_meta_save($post_id) {
...
add_action('save_post', 'crispprop_gallery_meta_save');
?>